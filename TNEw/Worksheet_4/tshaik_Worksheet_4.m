...
% squared plus leg 2 square, this using the math formula for the
% pythagorean theorem
hypotenuse = sqrt(leg1^2 + leg2^2); 

% This line has a fuction to round the value give by the
% basic_pythagHypotenuse fuction and check if it's not equal to the
% hypotenuse and if doesnt give a value, it prints the message in like 34
